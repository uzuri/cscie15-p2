...
<p><label for="inc_num">Include a number?</label><input name="inc_num" type="radio" value="1" /> Yes | <input name="inc_num" type="radio" value="0" checked="checked" /> No</p>
<p><label for="inc_char">Include a special character (!,@,#,$,%, etc.)?</label><input name="inc_char" type="radio" value="1" /> Yes | <input name="inc_char" type="radio" value="0" checked="checked" /> No</p>
